...
INSERT INTO `usuario` (`id`, `nombre`, `apellido`, `email`, `pass`) VALUES
	(1, 'Eduardo', 'Lihuisi', 'eduardo.lihuisi@tecsup.edu.pe', '123'),
	(2, 'Sebastian', 'Durand', 'sebastian.durand@tecsup.edu.pe', '123'),
	(3, 'Agueda', 'Calleja', 'agueda.calleja@tecsup.edu.pe', '123');
